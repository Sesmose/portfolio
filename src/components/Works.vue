    ...
    <section id="experiences">
        <div class="container my-24 px-6 mx-auto">
            <section class="mb-32 text-gray-800">
                <div class="max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-4">
                    <div class="font-light text-white sm:text-lg dark:text-white">
                        <h2 class="mb-4 text-4xl   dark:text-white"><span class="numberSection">02.</span>Mes expériences
                        </h2>
                        <p class="mb-4"></p>
                        <app-tabs :tabList="tabList" variant="horizontal">
                            <template class="ml-5" v-slot:tabPanel-1>
                                ...
                                <ol class="list-disc">
                                    ...
                                    <li>Présentation d'un projet complet</li>
                                </ol>
                            </template>
                            <template class="ml-5" v-slot:tabPanel-2>
                            ...
                            <template class="ml-5" v-slot:tabPanel-3>
                                <p class="font-bold">Titre RNCP Bac +5 Manager Systèmes d'Informations</p>
                                <p class="mb-4"></p>
                                <ol class="list-disc">
                                    <li>Solidification des compétences techniques</li>
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-8">
                        <img class="w-full rounded-lg" src="../../public/webforce.png" alt="logo webforce">
                        <img class="mt-4 w-full lg:mt-10 rounded-lg" src="../../public/cesi.png" alt="logo cesi">
                    </div>
                </div>
            </section>
        </div>
